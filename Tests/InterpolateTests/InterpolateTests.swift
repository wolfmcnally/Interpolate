...
final class InterpolateTests: XCTestCase {
    func testScalar() {
        ...
        XCTAssertEqual(a.interpolate(from: b, at: 150), 0.5)
        XCTAssertEqual((150).interpolate(from: r), 0.5)
        XCTAssertEqual(interpolate(to: r)(0.5), 150)
        XCTAssertEqual(interpolate(from: r)(150), 0.5)
    ...
    func testSIMD() {
        ...
        XCTAssertEqual(interpolate(to: r)(0.5), [200, 300])
